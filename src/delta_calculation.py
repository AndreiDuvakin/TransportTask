from src.create_zero_list import create_zero_vector
from src.vectors_multiplication import vectors_multiplication


def delta_calculation(cost_matrix: list[list[int]], storages: list[int], shops: list[int], item_cors: list[int]):
